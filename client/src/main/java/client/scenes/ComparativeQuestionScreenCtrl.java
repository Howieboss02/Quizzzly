...
public class ComparativeQuestionScreenCtrl {
    ...
    private void setQuestionNumber(){
        if(questionMode == 0){
            System.out.println("comp " + question.getCorrect_answer());
        } else if(questionMode == 1){
            System.out.println("mc " +mcQuestion.getCorrect_answer());
        } else if(questionMode == 2){
            System.out.println("equal " + equalityQuestion.getCorrect_answer());
        }
